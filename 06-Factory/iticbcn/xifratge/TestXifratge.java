        ...
        for (int i = 0; i < aFactory.length; i++) { 
            ...
            for (String msg : msgs) { 
                for (String clau : claus[i]) { 
                    ...
                    System.out.println("Algorisme: " + nom);  System.out.println("Clau: " + clau); 
                    TextXifrat tx = null; 
                    ...
                    System.out.println("TextXifrat: " + tx);  String desxifrat = null; 

                    try { 
                        desxifrat = xifrador.desxifra(tx, clau);  } catch (ClauNoSuportada e) 
                    { 
                        System.err.println(e.getLocalizedMessage());  
                    } 

                    System.out.println("Desxifrat: " + desxifrat);  System.out.println("------------------");  
                } 
            } 
        } 
    } 
